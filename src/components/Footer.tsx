...
const Footer: Component = () => {
  return (
    <footer class="border-t border-[#2D2D2D] mt-auto">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="py-4 flex justify-between items-center">
          <div class="flex items-center space-x-2 text-neutral-400">
            <span class="font-mono text-xs">Built by</span>
            <a 
              href="https://juanrmb.pages.dev" 
              target="_blank" 
              rel="noopener noreferrer" 
              class="font-mono text-xs text-white hover:text-[#0066FF] transition-colors duration-200"
            >
              Juan
            </a>
          </div>
          ...
          <div class="flex items-center space-x-2 text-neutral-400">
            <span class="font-mono text-xs">Powered by</span>
            <span class="font-mono text-xs text-white">Cloud Flare</span>
            <div class="w-4 h-4 text-[#F6821F] flex items-center translate-y-[0.5px]">
              <svg viewBox="0 0 256 116" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
